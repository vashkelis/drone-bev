...
```text
Improve metric homography calibration in Notebook 02B.
```

Once the road-plane calibration is reliable, the GT-based cuboid scene should become much more geometrically consistent.
